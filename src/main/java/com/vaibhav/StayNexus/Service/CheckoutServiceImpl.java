...
import com.vaibhav.StayNexus.Repositories.BookingRepository;
...
public class CheckoutServiceImpl implements CheckoutService {
    ...
    @Override
    public String getCheckoutSession(BookingEntity booking,
                                     String successUrl,
                                     String failureUrl) {
        log.info("Creating Stripe checkout session for booking id: {}", booking.getId());
        ...
        try {
            ...
            log.error("Stripe error creating session for booking {}: {}",
